<template>
    <section class="container mx-auto flex items-center justify-evenly p-4 gap-10">
      <div class="flex flex-col">
        ...
        <p class="text-lg font-bold mb-4">Full-Stack Developer</p>
        <div class=""> <!-- //Agregado contenedor flex para centrar el enlace verticalmente -->
          <a class="bg-c_primary text-xl font-bold px-6 py-2 rounded-xl inline-block">Conectar</a>
        </div>
      </div>
